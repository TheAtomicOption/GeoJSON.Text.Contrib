...
namespace GeoJSON.Text.Contrib.MsSqlSpatial.Test
{
    ...
    {
        /// <summary>
        /// See https://github.com/GeoJSON-Net/GeoJSON.Text.Contrib/issues/21
        /// </summary>
        [TestMethod]
        public void Issue21_PointInsideGeography()
        {
            ...
            var geoJsonWashington = JsonConvert.DeserializeObject<GeoJSON.Text.Feature.Feature>(stateWashington);
        ...
        public void Issue21_PointOutsideGeography()
        {
            ...
            var geoJsonArkansas = JsonConvert.DeserializeObject<GeoJSON.Text.Feature.Feature>(stateArkansas);
