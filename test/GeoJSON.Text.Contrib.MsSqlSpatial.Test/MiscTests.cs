...
namespace GeoJSON.Text.Contrib.MsSqlSpatial.Test
{
    ...
    public class MiscTests
    {
        ...
        public void Issue21_PointInsideGeography()
        {
            ...
            var geoJsonWashington = JsonSerializer.Deserialize<GeoJSON.Text.Feature.Feature>(stateWashington);
        ...
        public void Issue21_PointOutsideGeography()
        {
            ...
            var geoJsonArkansas = JsonSerializer.Deserialize<GeoJSON.Text.Feature.Feature>(stateArkansas);
